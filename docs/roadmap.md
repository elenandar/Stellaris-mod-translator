...
### M1B-1A-R1-AUTH v6 — post-merge transport and evidence-provenance remediation

[Canonical scope](../registry/m1b/m1b-1a-r1-remediation-scope-v6.json),
...
Scope v6 bind-ит PR #10 как historical merged baseline: head
...
`SCOPE_V5: SUPERSEDED_BEFORE_EFFECT`; ни одна из v1/v2/v3/v4/v5 не авторизует merge
retroactively.
