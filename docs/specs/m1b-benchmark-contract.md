...
- Версия proposal: `m1b-benchmark-contract-v6`; protocol generation `107`;
...
Trusted analysis component — `m1b-analysis-policy-v6`, generation `107`.
...
Для `m1b-benchmark-contract-v6` public bundle обязан содержать ровно `17`
...
Попытка завершить `complete_benchmark` в protocol v6 с document schema v4
...
Следующие operational defaults являются **proposal protocol v6 и ожидают owner
