...
- Версия proposal: `m1b-benchmark-contract-v3`; protocol generation `103`;
...
Trusted analysis component — `m1b-analysis-policy-v3`, generation `103`.
...
Для `m1b-benchmark-contract-v3` public bundle обязан содержать ровно `17`
...
Следующие operational defaults являются **proposal M1B-v3 и ожидают owner
