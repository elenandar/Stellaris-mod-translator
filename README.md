...
- [Post-merge transport/provenance remediation scope M1B-1A-R1-AUTH v5](registry/m1b/m1b-1a-r1-remediation-scope-v5.json)
...
- [Machine owner authorization M1B-1A-R1-AUTH v5](docs/decisions/M1B-1A-R1-AUTH-owner-authorization.json)
- [Owner signoff M1B-1A-R1-AUTH v5](docs/decisions/M1B-1A-R1-AUTH-owner-signoff.md)
...
Отдельный
[M1B-1A-R1-AUTH v5 scope](registry/m1b/m1b-1a-r1-remediation-scope-v5.json)
...
`R1_REMEDIATION: NOT_AUTHORIZED_UNTIL_V5_MERGE` и
`EFFECT: NOT_ACTIVE_UNTIL_OWNER_REVIEW_AND_MERGE`.
