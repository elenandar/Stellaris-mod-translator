...
- [Post-merge transport/provenance remediation scope M1B-1A-R1-AUTH v9](registry/m1b/m1b-1a-r1-remediation-scope-v9.json)
...
- [Machine owner authorization M1B-1A-R1-AUTH v9](docs/decisions/M1B-1A-R1-AUTH-owner-authorization.json)
- [Owner signoff M1B-1A-R1-AUTH v9](docs/decisions/M1B-1A-R1-AUTH-owner-signoff.md)
...
Отдельный
[M1B-1A-R1-AUTH v9 scope](registry/m1b/m1b-1a-r1-remediation-scope-v9.json)
...
`R1_REMEDIATION: NOT_AUTHORIZED_UNTIL_V9_MERGE` и
