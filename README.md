...
- [Post-merge transport/provenance remediation scope M1B-1A-R1-AUTH v8](registry/m1b/m1b-1a-r1-remediation-scope-v8.json)
...
- [Machine owner authorization M1B-1A-R1-AUTH v8](docs/decisions/M1B-1A-R1-AUTH-owner-authorization.json)
- [Owner signoff M1B-1A-R1-AUTH v8](docs/decisions/M1B-1A-R1-AUTH-owner-signoff.md)
...
Отдельный
[M1B-1A-R1-AUTH v8 scope](registry/m1b/m1b-1a-r1-remediation-scope-v8.json)
...
`SCOPE_V7: SUPERSEDED_BEFORE_EFFECT`,
`R1_REMEDIATION: NOT_AUTHORIZED_UNTIL_V8_MERGE` и
