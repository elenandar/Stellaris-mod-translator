...
The manifest contains 22 cases, including isolated record siblings, empty,
unbalanced, orphan and crossing delimiters, formatting-state failures, nested
fixture-backed formatting, and delimiter-like Unicode text. A table-driven
unit test also checks each ambiguous markup member independently.
